...
public class WebViewDemo extends Application {
    ...
    public void start(final Stage stage) {
        ...
        Button buttonURL = new Button("Load Page http://www.french-linguistics.co.uk/freng.exe?word=fleur");
        ...
        buttonURL.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                String url = "http://www.french-linguistics.co.uk/freng.exe?word=fleur";
